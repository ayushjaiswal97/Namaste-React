...
const RestaurantCard = (props) => {
    const { resData } = props;
    const { imageId, name, cuisines, avgRating, costForTwo, deliveryTime } = resData?.data;
    return (
